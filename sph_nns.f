...
!             forbid tree descents by this path:
      ...
      subroutine effective_neighbors(i,r_i) /* Search for Relevant Neighbors */
      /*
      WARNING:
...
#  ifdef _2D
        h(i)= h(i)*(1+y*((1+y)*n_fix/(n_fix+neighb(i)*y))**.5)/(1+y)
#  else
...
!///////////////////////////////////////////////////////////////////////
      ...
      include 'SPH_common.h'
#ifdef _DEBUG
      !!print*,'calculating h for particle',i
#endif
      itercount=0
      repeat=.true.
      do while(repeat)
