C     KAP/Digital_UA_F      4.0 k3011126 980529 o5r3so3  17-Jul-2000 13:00:11
# 1 "SPH_tree.F"
! 
!
...
!
     ...
     X   U_LUM, U_COOL, U_PH, E_N, R_SOL, SN_LIF_TIME, SN_ENE, T_SN, 
     X   STAR_MASS, N_STR, Y, STR_G, STAR_MIN, STAR_MAX, SN_MASS, SOLAR,
     X    U_SOL
...
CGS --> computer units:
     ...
     X   0.1207747E-03, U_LUM = 0.6962331E-32, U_COOL = 0.2251604E+24, 
     X   U_ENER = DBLE (0.2206062E-45), U_VOL = DBLE (0.3092165E-55))
...
!
       COMMON /ROWS/ ROW
       DIMENSION BBG(2), ANGMOM(2), VMOMENT(2)
 
       COMMON /MOMENTA/ VMOMENT, ANGMOM, BBG
       DIMENSION KRONECKER(2,2)
 
       COMMON /IDENTITY/ KRONECKER
       DIMENSION LEVI_CIVITA(2,2,2)
...
!
       ...
       DIMENSION GRAD_W(40960,96,2)
 
 
 
 
       COMMON /GRAD_LIST/ GRAD_W
       DIMENSION P_ACC(40960,2), Q_ACC(40960,2), G(40960,2)
...
!
       ...
       DIMENSION CELLMASS(40959,4)
       COMMON /TREE_REAL_1/ CELLMASS
       DIMENSION X_CELL(40959,4,2)
       COMMON /TREE_REAL_3/ X_CELL
       DIMENSION P_INERTIA(40959,4,2,2)
       COMMON /TREE_REAL_6/ P_INERTIA
       DIMENSION DOWN(40959,4), LABEL(40959,4), NP(40959,4)
       COMMON /TREE_INTG/ NP, LABEL, DOWN
       DIMENSION GNODE(163836,2)
 
       COMMON /GNODES/ GNODE
       DIMENSION XP(40960,2)
 
 
       COMMON /POSITIONS/ XP
       DIMENSION V(40960,2)
       COMMON /VELOCITIES/ V
       DIMENSION V_OLD(40960,2), V_O(40960,2)
 
       COMMON /V0/ V_O, V_OLD
       DIMENSION ACCEL(40960,2)
       COMMON /RESULT_ACC/ ACCEL
       DIMENSION BOX(40960,2)
       ...
       DIMENSION AUX(40960,2)
 
       COMMON /AUX/ AUX
       EQUIVALENCE (AUX, VERTIX)
       DIMENSION VERTIX(1,2)
       INTEGER*2 HI3, HI2, HI1
       INTEGER II1
       PARAMETER (HI3 = 0, HI2 = 2, II1 = 2, HI1 = 1)
...
C     KAP/Digital_UA_F      4.0 k3011126 980529 o5r3so3  17-Jul-2000 13:00:11
      SUBROUTINE PKSETBOX_ ( MPPID, MPPNPR, SCALE1 )
       EQUIVALENCE (VERTIX1(1,1), RR1(1))
       EQUIVALENCE (AUX1(1,1), RR1(1))
       INTEGER DIM1
       PARAMETER (DIM1 = 2)
       INTEGER MPPNPR
       INTEGER N1
...
!
       ...
       INTEGER II3, II2, II1
       INTEGER*2 HI3, HI2, HI1
       PARAMETER (II3 = 1, II2 = 2, HI3 = 3, HI2 = 1, HI1 = 2)
       PARAMETER (II1 = 0)
       SAVE CHANGING
       REAL RR2, RR1
       ISINGULARITY = II1
...
!
       ...
       INTEGER*2 HI2, HI1
       INTEGER II4, II3, II2, II1
       PARAMETER (HI2 = 2, II4 = 0, II3 = 2, II2 = 1, II1 = 4)
       PARAMETER (HI1 = 1)
       REAL RR2, RR1
       LOGICAL LL1
...
!
       ...
       INTEGER*2 HI2, HI1
       INTEGER II2, II1
       PARAMETER (HI2 = 0, II2 = 4, HI1 = 1, II1 = 0)
       IDEGEN = II1
       DO CELL=HI1,II2
...
!
       ...
       INTEGER*2 HI3, HI2, HI1
       INTEGER II2, II1
       PARAMETER (HI3 = 3, HI2 = 2, II2 = 2, HI1 = 1, II1 = 0)
       DO I=IA,IB
        CELL = II1
        DO J=HI1,II2
         CELL = CELL * HI2
         BOX(T(I,HI2),J) = BOX(T(I,HI2),J) * HI2
         ...
         IF (BOX(T(I,HI2),J) .GT. 1.) THEN
          BOX(T(I,HI2),J) = BOX(T(I,HI2),J) - HI1
          CELL = CELL + HI1
         END IF
 
         IF (BOX(T(I,HI2),J) .GT. 1.) THEN
          PRINT *, 'FindOctants: error'
          PRINT *, 'box=', BOX(T(I,HI2),J)
          STOP 
         END IF
...
!
       ...
       INTEGER II3, II2, II1
       INTEGER*2 HI1
       PARAMETER (II3 = 2, II2 = 0, II1 = 4, HI1 = 1)
